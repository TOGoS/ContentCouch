...
public class SizeOf extends BaseActiveFunction {
	public Response call( Map argumentExpressions ) {
		...
		if( o instanceof Blob ) return new BaseResponse(new Long(((Blob)o).getLength()));
		if( o instanceof String ) return new BaseResponse(new Long(ValueUtil.getBytes((String)o).length));
		if( o instanceof byte[] ) return new BaseResponse(new Long(((byte[])o).length));
