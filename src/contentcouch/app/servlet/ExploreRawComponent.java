...
public class ExploreRawComponent extends BaseSwfComponent {
	protected String externalPath;
	
	public ExploreRawComponent(String externalPath) {
	...
	protected String getInternalProcessingUri( String uri ) {
		return uri;
	}
	...
	public Response handleRequest(Request request) {
		...
		String internalUri = getInternalProcessingUri( uri );
